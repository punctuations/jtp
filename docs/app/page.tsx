...
`}
        ...
        <section id="transport" className="mb-10">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-xs sm:text-sm leading-6 text-black/80">
            ...
            <li>
              JTP may be wrapped in <strong>TLS</strong> to provide
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-xs sm:text-sm leading-6 text-black/80">
            ...
            <li>
              Clients that support ALPN <strong>SHOULD</strong> offer{" "}
              <span className="font-mono">jtp/1</span>.
            </li>
            <li>
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-xs sm:text-sm leading-6 text-black/80">
            <li>
              ...
              connection open after sending the response.
            </li>
            <li>
              If the flag is not set, the server <strong>SHOULD</strong> close
              the connection after the response.
            </li>
            <li>
              Servers <strong>MAY</strong> implement idle timeouts to close
              stale keep-alive connections.
            </li>
            <li>
              Clients <strong>MUST</strong> handle server-initiated connection
              closes gracefully.
            </li>
          </ul>
        </section>
          ...
          <Table
            rows={[
              [
                "Bit 0",
                "keep-alive",
                "1 = keep connection open after response",
              ],
          ...
          <div className="mt-6 grid gap-6">
            ...
            <div>
              ...
              <p className="mt-3 text-xs sm:text-sm leading-6 text-black/80">
                ...
                (after decompression if compressed).
              </p>
            </div>
              ...
              <Table
                rows={[
                  ...
                  [
                    "Images",
                    "variable",
                    "Repeated MissingCount times (image packet)",
                  ],
                ]}
              />
            </div>
        ...
        <section id="limits" className="mb-10">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-xs sm:text-sm leading-6 text-black/80">
            ...
            <li>
              Maximum images per LIST: <strong>65,535</strong> (u16 count)
            </li>
            <li>
              Maximum GET_BY_ID count: <strong>255</strong> (u8 count)
            </li>
            <li>
              Servers <strong>SHOULD</strong> reject BATCH requests with
              HaveCount exceeding <strong>1,000,000</strong>
            </li>
          </ul>
        </section>
        ...
        <section id="security" className="mb-10">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm leading-6 text-black/80">
            ...
            <li>
              ImageID is content-derived and can be used to validate integrity,
              but it is not a cryptographic MAC.
            </li>
            <li>
              Servers should validate and cap counts/sizes to mitigate
              denial-of-service.
            </li>
          </ul>
        </section>
